...
export default [
  ...
  },
  {
    ...
    abstract: `
      <p>
        The VIIRS Aerosol Optical Depth (AOD) product quantifies the amount of light that aerosols scatter and absorb as it travels through the atmosphere, providing a measure of aerosol concentration in the air. Derived from the VIIRS instrument aboard the Suomi NPP and NOAA-20 satellites, AOD data is essential for understanding air quality, climate forcing, and visibility conditions. This product captures aerosols such as smoke, dust, and pollution over both land and ocean surfaces with high spatial resolution and daily global coverage. AOD values are particularly useful for tracking wildfire smoke, assessing pollution transport, and feeding into climate and weather models. By translating satellite observations into a reliable indicator of atmospheric aerosol load, VIIRS AOD plays a vital role in environmental monitoring and public health research.
      </p>
      `,
  ...
  },
  {
    ...
    abstract: `
      <p>
        The VIIRS Aerosol Detection Product (ADP) is a satellite-derived dataset that provides critical information on the presence and spatial extent of aerosols in the atmosphere, such as smoke, dust, and other fine particulates. Generated by the Visible Infrared Imaging Radiometer Suite (VIIRS) onboard the Suomi NPP and NOAA-20 satellites, this product helps identify aerosol plumes and their movement over land and ocean surfaces. The ADP is especially valuable for environmental monitoring, public health assessments, and wildfire response, as it allows analysts and researchers to detect and track smoke from active fires in near real-time. With its high spatial resolution and daily global coverage, the VIIRS ADP supports timely decision-making and complements other satellite products like aerosol optical depth (AOD) for a comprehensive understanding of atmospheric particulate matter.
      </p>
      `,
